...
<body>
  <script>
    ...
    <div data-role="header" data-theme="b" data-position="fixed">
			<h1><img src="로고.png" alt="" width="50" height="50" id="imgMargin"/>매물 등록</h1>
      ...
      <div data-role="content" class="center">
        <div class="clearboth">
          ...
          <div class="rightfloat">
						<input class="input-text" type="text" name="title" size="30" required>
					</div>
				</div>
				<div class="clearboth">
					<div class="leftFloat labelmargin">사건번호</div>
          <div class="rightfloat">
						<input class="input-text" type="text" name="number" size="30" required>
					</div>
				</div>
				<div class="clearboth">
					<div class="leftFloat labelmargin">소재지</div>
          <div class="rightfloat">
						<input class="input-text"type="text" name="location" size="30" required>
					</div>
				</div>
				<div class="clearboth">
					<div class="leftFloat labelmargin">경매구분</div>
          <div class="rightfloat">
						<input class="input-text" type="text" name="auction_sort" size="30" required>
					</div>
				</div>
				<div class="clearboth">
					<div class="leftFloat labelmargin">용도</div>
          <div class="rightfloat">
						<input class="input-text" type="text" name="use_sort" size="30" required>
					</div>
				</div>
				<div class="clearboth">
					<div class="leftFloat labelmargin">감정가</div>
          <div class="rightfloat">
						<input class="input-text" type="text" name="appraisal_price" size="30" required>
					</div>
				</div>
				<div class="clearboth">
					<div class="leftFloat labelmargin">최저가</div>
          <div class="rightfloat">
						<input class="input-text" type="text" name="lowest_price" size="30" required>
					</div>
				</div>
				<div class="clearboth">
					<div class="leftFloat labelmargin">입찰보증금</div>
          <div class="rightfloat">
						<input class="input-text" type="text" name="bid_bond" size="30" required>
					</div>
				</div>
				<div class="clearboth">
					<div class="leftFloat labelmargin">토지면적</div>
          <div class="rightfloat">
						<input class="input-text" type="text" name="land_area" size="30" required>
					</div>
				</div>
				<div class="clearboth">
					<div class="leftFloat labelmargin">건물면적</div>
            <div class="rightfloat">
						<input class="input-text" type="text" name="building_area" size="30" required>
					</div>
				</div>
				<div class="clearboth">
					<div class="leftFloat labelmargin">매각기일</div>
          <div class="rightfloat">
						<input class="input-text" type="text" name="deadline_date" size="30" required>
					</div>
				</div>
        <div class="clearboth">
